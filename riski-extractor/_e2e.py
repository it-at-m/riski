...
from core.model.data_models import Paper, Person, Organization, LegislativeTerm, Location
...
def main():
    ...
    print(f"Person rows: {len(request_all(Person))}, Org rows: {len(request_all(Organization))}, "
