...
<template>
    <div class="data-section">
        ...
        <div v-if="sortedProposals.length > 0" class="source-section">
            <h4 class="source-subheading">Anträge</h4>
            <ul class="source-list">
                <li v-for="proposal in sortedProposals" :key="proposal.identifier" class="source-item">
                    <div class="source-item-header">
                        <span class="source-identifier">{{ proposal.identifier }}</span>
                        <span v-if="proposal.date" class="source-date">{{ formatDate(proposal.date) }}</span>
                    </div>
                    ...
                    <p v-if="proposal.subject" class="source-subject">
                        {{ proposal.subject }}
                    </p>
                </li>
            </ul>
